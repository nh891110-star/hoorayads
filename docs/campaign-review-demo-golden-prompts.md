...
| LEAD-01 | `Show me a no-OAuth Campaign Review demo for Lead Generation. Name it July Lead Capture, budget USD 80/day, CBO off, no catalog, and confirm that no special ad category applies.` | Lead generation card; no Sales destination or App fields. |
