...
**Widget:** Campaign Review `v13` with legacy aliases for cached connector versions
...
1. Repeat **EDIT-01** in a fresh ChatGPT conversation that loads widget `v13`, and visually confirm the revised values remain visible.
